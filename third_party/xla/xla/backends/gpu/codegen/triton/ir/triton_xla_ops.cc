...
static LogicalResult verifyExtractInsert(Operation* op,
...
LogicalResult InsertOp::verify() {
  return verifyExtractInsert(getOperation(), getSrc().getType(),
                             getDst().getType(), getDstLayoutAttr(),
                             getDstShape(), getStaticSizes());
}
